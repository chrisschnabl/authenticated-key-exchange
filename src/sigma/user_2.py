...
class User(BaseModel):
    ...
    def __init__(self, identity: str, ca: CertificateAuthority, network: SimulatedNetwork):
        signing_key = SigningKey.generate()
        verify_key = signing_key.verify_key
        # TODO: ask users to proof their idendity
    ...
    def _(self, message: SigmaMessage2, sender: str) -> None:
        ...
        # TODO: make sure this is a verified key
